    ...
    return (
        <>
            ...
            <div className="containersendmess" >
                <div className="sendmess-box">
                    <h3 className="heading">Send Whatsapp Message</h3>
                    <div>
                        <label htmlFor="">Select the excel file :-</label>
                        ...
                        <br />
                        <a className='anchor-text' href="#" onClick={(e) => { e.preventDefault(); document.getElementById('clicked').click() }}>Upload Excel File</a> &nbsp; &nbsp;

                        <a className="formate-text " href={Formate} download>
                        ...
                        <br />
                        <a className='anchor-text' href="#" onClick={(e) => { e.preventDefault(); document.getElementById('clickedImage').click() }}>Upload Image</a>
